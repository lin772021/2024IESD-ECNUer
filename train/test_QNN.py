...
from help_code_QNN import ToTensor, ECG_DataSET, F1, FB, Sensitivity, Specificity, BAC, ACC, PPV, NPV
...
def main():
    ...
    net = torch.load(path_net + 'ECG_net_16.pkl')
    net.eval()
    # change
    # net.cuda()
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--path_net', type=str, default='./saved_models/cry/')
