...
def main():
    ...
    for epoch in range(epoch_num):  # loop over the dataset multiple times (specify the #epoch)
        ...
        torch.save(net, f'./saved_models/QNN/ECG_net_{epoch+1}.pkl')
        torch.save(net.state_dict(), f'./saved_models/QNN/ECG_net_state_dict_{epoch+1}.pkl')
